...
class MCPManager:
        ...
        try:
            ...
            if server_config.type == "sse":
                ...
                client = MCPClient(
                    ...
                    client_name=f"ai_coder_{server_name}"
                )
            ...
            if connected:
                ...
                return {
                    "success": False,
                    "error": f"连接MCP服务器失败: {server_name}"
                }
                
        except Exception as e:
            return {
                "success": False,
                "error": f"连接MCP服务器异常: {str(e)}"
            }
    ...
    async def remove_server(self, server_name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "success": True,
                "message": f"MCP服务器已移除: {server_name}"
            }
            
        except Exception as e:
            return {
                "success": False,
                "error": f"移除MCP服务器失败: {str(e)}"
            }
    ...
    async def disable_server(self, server_name: str) -> Dict[str, Any]:
        ...
        return {
            "success": True,
            "message": f"MCP服务器已禁用: {server_name}"
        }
