...
| Platform | Download                                                                                                |
|----------|---------------------------------------------------------------------------------------------------------|
| macOS (Apple Silicon) | [AACode_1.7.12_aarch64.dmg](https://github.com/kandada/aacode/raw/main/desktop/AACode_1.7.12_aarch64.dmg) |
| Windows | [AACode_1.7.12_x64-setup.exe](https://github.com/kandada/aacode/raw/main/desktop/AACode_1.7.12_x64-setup.exe) |
