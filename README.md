...
| Platform | Download                                                                                                |
|----------|---------------------------------------------------------------------------------------------------------|
| macOS (Apple Silicon) | [AACode_1.8.6_aarch64.dmg](https://github.com/kandada/aacode/raw/main/desktop/AACode_1.8.6_aarch64.dmg) |
| Windows | [AACode_1.8.6_x64-setup.exe](https://github.com/kandada/aacode/raw/main/desktop/AACode_1.8.6_x64-setup.exe) |
