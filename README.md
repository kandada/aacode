...
| Platform | Download                                                                                                |
|----------|---------------------------------------------------------------------------------------------------------|
| macOS (Apple Silicon) | [AACode_1.8.3_aarch64.dmg](https://github.com/kandada/aacode/raw/main/desktop/AACode_1.8.3_aarch64.dmg) |
| Windows | [AACode_1.8.3_x64-setup.exe](https://github.com/kandada/aacode/raw/main/desktop/AACode_1.8.3_x64-setup.exe) |
