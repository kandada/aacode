...
| 平台 | 下载链接 | 文件名 |
|------|----------|--------|
| macOS (Apple Silicon) | [下载](https://github.com/kandada/aacode/raw/main/desktop/AACode_1.7.24_aarch64.dmg) | AACode_1.7.24_aarch64.dmg |
| Windows | [下载](https://github.com/kandada/aacode/raw/main/desktop/aacode-desktop-1.7.24.exe) | aacode-desktop-1.7.24.exe |

## 🛠️ 安装步骤

### 1. 安装 Python 环境

AACode Desktop 依赖 Python 运行后端服务，请先安装 Python 3.10+。
